...
func TestApps_CreateApp(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/apps", func(w http.ResponseWriter, r *http.Request) {
...
func TestApps_GetApp(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s", testApp.ID), func(w http.ResponseWriter, r *http.Request) {
...
func TestApps_ProposeApp(t *testing.T) {
	...
	spec := &AppSpec{
		...
		Services: []*AppServiceSpec{{
			...
			GitHub: &GitHubSourceSpec{
				Repo:   "abrha/sample-golang",
				Branch: "branch",
			},
		}},
	}

	mux.HandleFunc("/api/public/v1/apps/propose", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
...
func TestApps_Restart(t *testing.T) {
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/restart", testApp.ID), func(w http.ResponseWriter, r *http.Request) {
				testMethod(t, r, http.MethodPost)
...
func TestApps_CreateDeployment(t *testing.T) {
	for _, forceBuild := range []bool{true, false} {
		t.Run(fmt.Sprintf("ForceBuild_%t", forceBuild), func(t *testing.T) {
			...
			mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/deployments", testApp.ID), func(w http.ResponseWriter, r *http.Request) {
				testMethod(t, r, http.MethodPost)
...
func TestApps_GetDeployment(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/deployments/%s", testApp.ID, testDeployment.ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_GetLogs(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/deployments/%s/logs", testApp.ID, testDeployment.ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_GetExec(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/deployments/%s/components/%s/exec", testApp.ID, testDeployment.ID, "service-name"), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/components/%s/exec", testApp.ID, "service-name"), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_GetLogs_ActiveDeployment(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/logs", testApp.ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_ListRegions(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/apps/regions", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_ListTiers(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/apps/tiers", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_GetTier(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/tiers/%s", testAppTier.Slug), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_ListInstanceSizes(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/apps/tiers/instance_sizes", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_GetInstanceSize(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/tiers/instance_sizes/%s", testInstanceSize.Slug), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_ListAppAlerts(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/alerts", testApp.ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_UpdateAppAlertDestinations(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/alerts/%s/destinations", testApp.ID, testAlert.ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
...
func TestApps_Detect(t *testing.T) {
	...
	gitSource := &GitSourceSpec{
		RepoCloneURL: "https://github.com/parspack/sample-nodejs.git",
		Branch:       "main",
	}
	...
	mux.HandleFunc("/api/public/v1/apps/detect", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
...
func TestApps_ListBuildpacks(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/apps/buildpacks", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_UpgradeBuildpack(t *testing.T) {
	...
	opts := UpgradeBuildpackOptions{
		BuildpackID:       "abrha/node",
		MajorVersion:      3,
		TriggerDeployment: true,
	}

	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/upgrade_buildpack", testApp.ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
...
func TestApps_GetAppDatabaseConnectionDetails(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/database_connection_details", testApp.ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestApps_ResetDatabasePassword(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/components/%s/reset_password",
...
func TestApps_ToggleDatabaseTrustedSource(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/apps/%s/components/%s/trusted_sources",
		testApp.ID, testApp.Spec.GetServices()[0].GetName(),
	), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodPost)
