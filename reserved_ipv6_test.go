...
func TestReservedIPV6s_List(t *testing.T) {
	...
	mux.HandleFunc("/v2/reserved_ipv6", func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprint(w, `{"reserved_ipv6s": [
			{"region_slug":"nyc3","vm":{"id":"1"},"ip":"2604:a880:800:14::42c3:d000"},
			{"region_slug":"nyc3","vm":{"id":"2"},"ip":"2604:a880:800:14::42c3:d001"}
			],
			"meta": {"total": 2}
		}`)
	})
	...
	expectedReservedIPs := []ReservedIPV6{
		{RegionSlug: "nyc3", Vm: &Vm{ID: "1"}, IP: "2604:a880:800:14::42c3:d000"},
		{RegionSlug: "nyc3", Vm: &Vm{ID: "2"}, IP: "2604:a880:800:14::42c3:d001"},
	}
...
func TestReservedIPV6s_ListReservedIPsMultiplePages(t *testing.T) {
	...
	mux.HandleFunc("/v2/reserved_ipv6", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{"reserved_ipv6s": [
			{"region_slug":"nyc3","vm":{"id":"1"},"ip":"2604:a880:800:14::42c3:d001"},
			{"region":{"slug":"nyc3"},"vm":{"id":"2"},"ip":"2604:a880:800:14::42c3:d002"}],
...
func TestReservedIPV6s_Get(t *testing.T) {
	...
	mux.HandleFunc("/v2/reserved_ipv6/2604:a880:800:14::42c3:d001", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{"reserved_ipv6":{"region_slug":"nyc3","vm":{"id":"1"},"ip":"2604:a880:800:14::42c3:d001", "reserved_at":"`+nowTime.Format(time.RFC3339Nano)+`"}}`)
	})
	...
	expected := &reservedIPV6Root{ReservedIPV6: &ReservedIPV6{RegionSlug: "nyc3", Vm: &Vm{ID: "1"}, IP: "2604:a880:800:14::42c3:d001", ReservedAt: nowTime}}
	if !equalReserveIPv6Objects(reservedIP, expected.ReservedIPV6) {
