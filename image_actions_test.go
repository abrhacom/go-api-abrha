...
func TestImageActions_Transfer(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/images/12345/actions", func(w http.ResponseWriter, r *http.Request) {
		v := new(ActionRequest)
...
func TestImageActions_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/images/123/actions/456", func(w http.ResponseWriter, r *http.Request) {
