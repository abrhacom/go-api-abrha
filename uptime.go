...
const (
	uptimeChecksBasePath = "/api/public/v1/uptime/checks"
...
// See: https://docs.parspack.com/reference/api/cloud-server/#tag/Uptime
...
func (p *UptimeChecksServiceOp) GetAlert(ctx context.Context, uptimeCheckID string, alertID string) (*UptimeAlert, *Response, error) {
	path := fmt.Sprintf("api/public/v1/uptime/checks/%s/alerts/%s", uptimeCheckID, alertID)
