	...
	jBlob := `
{
	...
	"links": {
	    "pages": {
			"next": "https://api.abrha.com/v2/kubernetes/clusters?page=2",
			"last": "https://api.abrha.com/v2/kubernetes/clusters?page=2"
		}
	},
	"meta": {
	    "total": 2
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters", func(w http.ResponseWriter, r *http.Request) {
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/user", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
...
func TestKubernetesClusters_GetKubeConfig(t *testing.T) {
	...
	want := "some YAML"
	blob := []byte(want)
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/kubeconfig", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, want)
	})
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/credentials", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
`
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/upgrades", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
...
`
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/8d91899c-0739-4a1a-acc5-deadbeefbb8f", func(w http.ResponseWriter, r *http.Request) {
...
func TestKubernetesClusters_Upgrade(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/8d91899c-0739-4a1a-acc5-deadbeefbb8f/upgrade", func(w http.ResponseWriter, r *http.Request) {
...
func TestKubernetesClusters_DeleteDangerous(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/destroy_with_associated_resources/dangerous", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
	})
...
`
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/destroy_with_associated_resources/selective", func(w http.ResponseWriter, r *http.Request) {
		buf := new(bytes.Buffer)
		buf.ReadFrom(r.Body)
		require.Equal(t, expectedReqJSON, buf.String())
...
`
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/destroy_with_associated_resources", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/8d91899c-0739-4a1a-acc5-deadbeefbb8f/node_pools", func(w http.ResponseWriter, r *http.Request) {
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/8d91899c-0739-4a1a-acc5-deadbeefbb8f/node_pools/8d91899c-0739-4a1a-acc5-deadbeefbb8a", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/8d91899c-0739-4a1a-acc5-deadbeefbb8f/node_pools/8d91899c-nodepool-4a1a-acc5-deadbeefbb8a", func(w http.ResponseWriter, r *http.Request) {
...
func TestKubernetesClusters_DeleteNodePool(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/node_pools/8d91899c-nodepool-4a1a-acc5-deadbeefbb8a", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
	})
...
func TestKubernetesClusters_DeleteNode(t *testing.T) {
	t.Run("default", func(t *testing.T) {
		...
		mux.HandleFunc("/api/public/v1/kubernetes/clusters/deadbeef-dead-4aa5-beef-deadbeef347d/node_pools/8d91899c-nodepool-4a1a-acc5-deadbeefbb8a/nodes/8d91899c-node-4a1a-acc5-deadbeefbb8a", func(w http.ResponseWriter, r *http.Request) {
			testMethod(t, r, http.MethodDelete)
...
func TestKubernetesClusters_RecycleNodePoolNodes(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/8d91899c-0739-4a1a-acc5-deadbeefbb8f/node_pools/8d91899c-nodepool-4a1a-acc5-deadbeefbb8a/recycle", func(w http.ResponseWriter, r *http.Request) {
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/options", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
...
func TestKubernetesClusterRegistry_Add(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/kubernetes/registry", func(w http.ResponseWriter, r *http.Request) {
	...
	jBlob := `
{
	...
	mux.HandleFunc("/api/public/v1/kubernetes/clusters/8d91899c-0739-4a1a-acc5-deadbeefbb8f/clusterlint", func(w http.ResponseWriter, r *http.Request) {
