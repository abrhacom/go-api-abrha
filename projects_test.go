...
func TestProjects_GetDefault(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/projects/default", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestProjects_GetWithUUID(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/projects/project-1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		resp, _ := json.Marshal(project)
		fmt.Fprintf(w, `{"project":%s}`, resp)
	})
...
func TestProjects_ListResources(t *testing.T) {
	...
	expectedResources := []ProjectResource{
		{
			...
			Links: &ProjectResourceLinks{
				Self: "http://example.com/v1/vms/1",
			},
		},
		{
	...
	mux.HandleFunc("/api/public/v1/projects/project-1/resources", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestProjects_AssignFleetResourcesWithTypes(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/projects/project-1/resources", func(w http.ResponseWriter, r *http.Request) {
		...
		req := strings.TrimSuffix(string(reqBytes), "\n")
		expectedReq := `{"resources":["do:vm:1234","do:floatingip:1.2.3.4","do:reservedip:1.2.3.4"]}`
		if req != expectedReq {
...
func TestProjects_AssignFleetResourcesWithTypeWithoutURNReturnsError(t *testing.T) {
	...
	if err.Error() != "go_api_abrha.fakeType must either be a string or have a valid URN method" {
