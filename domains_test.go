...
func TestDomains_ListDomains(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/domains", func(w http.ResponseWriter, r *http.Request) {
...
func TestDomains_GetDomain(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/domains/example.com", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestDomains_AllRecordsForDomainName(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/domains/example.com/records", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestDomains_GetRecordforDomainName(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/domains/example.com/records/1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestDomains_CreateRecordForDomainName(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/domains/example.com/records",
...
func TestDomainRecord_String(t *testing.T) {
	...
	expected := `go_api_abrha.DomainRecord{ID:1, Type:"CNAME", Name:"example", Data:"@", Priority:10, Port:10, TTL:1800, Weight:10, Flags:1, Tag:"test"}`
...
func TestDomainRecordEditRequest_String(t *testing.T) {
	...
	stringified := record.String()
	expected := `go_api_abrha.DomainRecordEditRequest{Type:"CNAME", Name:"example", Data:"@", Priority:10, Port:10, TTL:1800, Weight:10, Flags:1, Tag:"test"}`
	assert.Equal(t, expected, stringified)
}
