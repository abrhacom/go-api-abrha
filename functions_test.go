...
func TestFunctions_ListNamespaces(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/functions/namespaces", func(w http.ResponseWriter, r *http.Request) {
...
func TestFunctions_GetNamespace(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/functions/namespaces/123-abc", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
			"namespace": {
				"api_host": "https://faas.do.com",
...
func TestFunctions_ListTriggers(t *testing.T) {
	setup()
	defer teardown()
	mux.HandleFunc("/api/public/v1/functions/namespaces/123-456/triggers", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
			"triggers": [
				{
...
func TestFunctions_GetTrigger(t *testing.T) {
	setup()
	defer teardown()
	mux.HandleFunc("/api/public/v1/functions/namespaces/123-456/triggers/my-trigger", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
			"trigger": {
				"name": "my-trigger",
...
func TestFunctions_DeleteTrigger(t *testing.T) {
	setup()
	defer teardown()
	mux.HandleFunc("/api/public/v1/functions/namespaces/123-abc/triggers/my-trigger", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
	})
