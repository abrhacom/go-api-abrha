...
func TestSizes_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/sizes", func(w http.ResponseWriter, r *http.Request) {
...
func TestSize_String(t *testing.T) {
	...
	expected := `go_api_abrha.Size{Slug:"slize", Memory:123, Vcpus:456, Disk:789, PriceMonthly:123, PriceHourly:456, Regions:["1" "2"], Available:true, Transfer:789, Description:"Basic"}`
