...
var (
	...
	getJSON = `
	{
		"tag": {
			...
			"resources": {
				"count": 5,
				"last_tagged_uri": "https://api.abrha.com/v1/vms/1",
				"vms": {
					"count": 1,
					"last_tagged_uri": "https://api.abrha.com/v1/vms/1",
					"last_tagged": {
				...
				"images": {
					"count": 1,
					"last_tagged_uri": "https://api.abrha.com/v2/images/1"
				},
				"volumes": {
					"count": 1,
					"last_tagged_uri": "https://api.abrha.com/v2/volumes/abc"
				},
				"volume_snapshots": {
					"count": 1,
					"last_tagged_uri": "https://api.abrha.com/v2/snapshots/1"
				},
				"databases": {
					"count": 1,
					"last_tagged_uri": "https://api.abrha.com/v2/databases/1"
				}
			}
		}
	}
...
func TestTags_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/tags", func(w http.ResponseWriter, r *http.Request) {
	...
	expectedTags := []Tag{
		{Name: "testing-1", Resources: &TaggedResources{Count: 0, Vms: &TaggedvmsResources{Count: 0, LastTagged: nil}, Images: &TaggedImagesResources{Count: 0}, Volumes: &TaggedVolumesResources{Count: 0}, VolumeSnapshots: &TaggedVolumeSnapshotsResources{Count: 0}, Databases: &TaggedDatabasesResources{Count: 0}}},
		{Name: "testing-2", Resources: &TaggedResources{Count: 0, Vms: &TaggedvmsResources{Count: 0, LastTagged: nil}, Images: &TaggedImagesResources{Count: 0}, Volumes: &TaggedVolumesResources{Count: 0}, VolumeSnapshots: &TaggedVolumeSnapshotsResources{Count: 0}, Databases: &TaggedDatabasesResources{Count: 0}}},
	}
...
func TestTags_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/tags/testing-1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
	...
	assertStringTagEqual(t, tag.Resources.LastTaggedURI, "https://api.abrha.com/v1/vms/1", fmt.Sprintf("Tags.Get return an incorrect last tagged uri %+v, expected %+v", tag.Resources.LastTaggedURI, "https://api.abrha.com/v1/vms/1"))
	assertIntTagEqual(t, tag.Resources.Vms.Count, 1, fmt.Sprintf("Tags.Get return an incorrect vm resource count, got %+v, expected %+v", tag.Resources.Vms.Count, 1))
	assertStringTagEqual(t, tag.Resources.Vms.LastTagged.ID, "1", fmt.Sprintf("Tags.Get return an incorrect last tagged vm %+v, expected %+v", tag.Resources.Vms.LastTagged.ID, "1"))
	assertStringTagEqual(t, tag.Resources.Vms.LastTaggedURI, "https://api.abrha.com/v1/vms/1", fmt.Sprintf("Tags.Get return an incorrect last tagged vm uri %+v, expected %+v", tag.Resources.Vms.LastTaggedURI, "https://api.abrha.com/v1/vms/1"))
	...
	assertStringTagEqual(t, tag.Resources.Images.LastTaggedURI, "https://api.abrha.com/v2/images/1", fmt.Sprintf("Tags.Get return an incorrect last tagged vm uri %+v, expected %+v", tag.Resources.Images.LastTaggedURI, "https://api.abrha.com/v2/images/1"))
	...
	assertStringTagEqual(t, tag.Resources.Volumes.LastTaggedURI, "https://api.abrha.com/v2/volumes/abc", fmt.Sprintf("Tags.Get return an incorrect last tagged volume uri %+v, expected %+v", tag.Resources.Volumes.LastTaggedURI, "https://api.abrha.com/v2/volumes/abc"))
	...
	assertStringTagEqual(t, tag.Resources.VolumeSnapshots.LastTaggedURI, "https://api.abrha.com/v2/snapshots/1", fmt.Sprintf("Tags.Get return an incorrect last tagged volume snapshot uri %+v, expected %+v", tag.Resources.VolumeSnapshots.LastTaggedURI, "https://api.abrha.com/v2/snapshots/1"))
	...
	assertStringTagEqual(t, tag.Resources.Databases.LastTaggedURI, "https://api.abrha.com/v2/databases/1", fmt.Sprintf("Tags.Get return an incorrect last tagged database uri %+v, expected %+v", tag.Resources.Databases.LastTaggedURI, "https://api.abrha.com/v2/databases/1"))
...
func TestTags_Create(t *testing.T) {
	...
	expected := &Tag{
		...
		Resources: &TaggedResources{
			Count:           0,
			Vms:             &TaggedvmsResources{Count: 0, LastTagged: nil},
...
func TestTags_TagResource(t *testing.T) {
	...
	tagResourcesRequest := &TagResourcesRequest{
		Resources: []Resource{
			{ID: "1", Type: VmResourceType},
			{ID: "1", Type: ImageResourceType},
		},
	}

	mux.HandleFunc("/api/public/v1/tags/testing-1/resources", func(w http.ResponseWriter, r *http.Request) {
