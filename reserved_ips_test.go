...
func TestReservedIPs_ListReservedIPs(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/reserved_ips", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{"reserved_ips": [
			{"region":{"slug":"nyc3"},"vm":{"id":"1"},"ip":"192.168.0.1","project_id":"46d8977a-35cd-11ed-909f-43c99bbf6032", "locked":false},
			{"region":{"slug":"nyc3"},"vm":{"id":"2"},"ip":"192.168.0.2","project_id":"46d8977a-35cd-11ed-909f-43c99bbf6032", "locked":false}],
			"meta":{"total":2}
		}`)
	})
	...
	expectedReservedIPs := []ReservedIP{
		{Region: &Region{Slug: "nyc3"}, Vm: &Vm{ID: "1"}, IP: "192.168.0.1", Locked: false, ProjectID: "46d8977a-35cd-11ed-909f-43c99bbf6032"},
		{Region: &Region{Slug: "nyc3"}, Vm: &Vm{ID: "2"}, IP: "192.168.0.2", Locked: false, ProjectID: "46d8977a-35cd-11ed-909f-43c99bbf6032"},
	}
...
func TestReservedIPs_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/reserved_ips/192.168.0.1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{"reserved_ip":{"region":{"slug":"nyc3"},"vm":{"id":"1"},"ip":"192.168.0.1","project_id":"46d8977a-35cd-11ed-909f-43c99bbf6032", "locked":false}}`)
	})
	...
	expected := &ReservedIP{Region: &Region{Slug: "nyc3"}, Vm: &Vm{ID: "1"}, IP: "192.168.0.1", Locked: false, ProjectID: "46d8977a-35cd-11ed-909f-43c99bbf6032"}
