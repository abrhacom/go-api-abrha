...
// See: https://docs.parspack.com/reference/api/cloud-server/#tag/Domains and
// https://docs.parspack.com/reference/api/cloud-server/#tag/Domain-Records
...
// domainRoot represents a response from the Abrha API
