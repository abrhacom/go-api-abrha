...
func TestKeys_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/account/keys", func(w http.ResponseWriter, r *http.Request) {
...
func TestKeys_ListKeysMultiplePages(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/account/keys", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{"vms": [{"id":1},{"id":2}], "links":{"pages":{"next":"http://example.com/v2/account/keys/?page=2"}}}`)
	})
...
func TestKeys_GetByID(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/account/keys/12345", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestKeys_GetByFingerprint(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/account/keys/aa:bb:cc", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestKeys_UpdateByFingerprint(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/account/keys/3b:16:bf:e4:8b:00:8b:b8:59:8c:a9:d3:f0:19:45:fa", func(w http.ResponseWriter, r *http.Request) {
		expected := map[string]interface{}{
			"name": "name",
		}
...
func TestKey_String(t *testing.T) {
	...
	expected := `go_api_abrha.Key{ID:123, Name:"Key", Fingerprint:"fingerprint", PublicKey:"public key"}`
