...
var (
	firstPageLinksJSONBlob = []byte(`{
		"links": {
			"pages": {
				"last": "https://api.abrha.com/v1/vms/?page=3",
				"next": "https://api.abrha.com/v1/vms/?page=2"
			}
		}
	}`)
	otherPageLinksJSONBlob = []byte(`{
		"links": {
			"pages": {
				"first": "https://api.abrha.com/v1/vms/?page=1",
				"prev": "https://api.abrha.com/v1/vms/?page=1",
				"last": "https://api.abrha.com/v1/vms/?page=3",
				"next": "https://api.abrha.com/v1/vms/?page=3"
			}
		}
	}`)
	lastPageLinksJSONBlob = []byte(`{
		"links": {
			"pages": {
				"first": "https://api.abrha.com/v1/vms/?page=1",
				"prev": "https://api.abrha.com/v1/vms/?page=2"
			}
		}
	}`)
	projectsLastPageLinksJSONBlob = []byte(`{
		"links": {
			"pages": {
				"first": "https://api.abrha.com/v2/projects?page=1",
				"prev": "https://api.abrha.com/v2/projects?page=2",
				"last": "https://api.abrha.com/v2/projects?page=3"
			}
		}
	}`)
...
type goApiAbrhaList struct {
	Links Links `json:"links"`
}

func loadLinksJSON(t *testing.T, j []byte) Links {
	var list goApiAbrhaList
...
func TestLinks_ParseURL(t *testing.T) {
	...
	linkTests := []linkTest{
		{
			name:         "prev",
			url:          "https://api.abrha.com/v1/vms/?page=1",
			expectedPage: 1,
		},
		{
			name:         "last",
			url:          "https://api.abrha.com/v1/vms/?page=5",
			expectedPage: 5,
		},
		{
			name:         "next",
			url:          "https://api.abrha.com/v1/vms/?page=2",
			expectedPage: 2,
		},
		{
			name:              "page token",
			url:               "https://api.abrha.com/v1/vms/?page=2&page_token=aaa",
			expectedPage:      2,
...
func TestLinks_NextPageToken(t *testing.T) {
	t.Run("happy token", func(t *testing.T) {
		checkNextPageToken(t, &Response{Links: &Links{
			Pages: &Pages{
				Next: "https://api.abrha.com/v1/vms/?page_token=aaa",
			},
		}}, "aaa")
	})
	t.Run("empty token", func(t *testing.T) {
		checkNextPageToken(t, &Response{Links: &Links{
			Pages: &Pages{
				Next: "https://api.abrha.com/v1/vms/",
			},
		}}, "")
	})
...
func TestLinks_ParseNextPageToken(t *testing.T) {
	t.Run("happy token", func(t *testing.T) {
		checkPreviousPageToken(t, &Response{Links: &Links{
			Pages: &Pages{
				Prev: "https://api.abrha.com/v1/vms/?page_token=aaa",
			},
		}}, "aaa")
	})
	t.Run("empty token", func(t *testing.T) {
		checkPreviousPageToken(t, &Response{Links: &Links{
			Pages: &Pages{
				Prev: "https://api.abrha.com/v1/vms/",
			},
		}}, "")
	})
	t.Run("no next page", func(t *testing.T) {
