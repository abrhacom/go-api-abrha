...
func TestStorageVolumes_ListStorageVolumes(t *testing.T) {
	...
	jBlob := `
	{
		...
		"links": {
	    "pages": {
	      "last": "https://api.abrha.com/v2/volumes?page=2",
	      "next": "https://api.abrha.com/v2/volumes?page=2"
	    }
	  },
	  "meta": {
	    "total": 28
	...
	mux.HandleFunc("/api/public/v1/volumes/", func(w http.ResponseWriter, r *http.Request) {
...
func TestStorageVolumes_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/volumes/80d414c6-295e-4e3a-ac58-eb9456c1e1d1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
...
func TestStorageSnapshots_ListStorageSnapshots(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/volumes/98d414c6-295e-4e3a-ac58-eb9456c1e1d1/snapshots", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
...
func TestStorageSnapshots_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/snapshots/80d414c6-295e-4e3a-ac58-eb9456c1e1d1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, jBlob)
	})
...
func TestStorageSnapshots_Create(t *testing.T) {
	...
	jBlob := `{
		...
		"links": {
	    "pages": {
	      "last": "https://api.abrha.com/v2/volumes/98d414c6-295e-4e3a-ac58-eb9456c1e1d1/snapshots?page=2",
	      "next": "https://api.abrha.com/v2/volumes/98d414c6-295e-4e3a-ac58-eb9456c1e1d1/snapshots?page=2"
	    }
	  },
	  "meta": {
	    "total": 28
