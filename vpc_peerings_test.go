...
func TestVPCPeering_Create(t *testing.T) {
	...
	svc := client.VPCs
	path := "/api/public/v1/vpc_peerings"
	want := vPeerTestObj
...
func TestVPCPeering_CreateByVPCID(t *testing.T) {
	...
	svc := client.VPCs
	path := "/api/public/v1/vpcs/%s/peerings"
	want := vPeerTestObj
	id := "880b7f98-f062-404d-b33c-458d545696f6"
...
func TestVPCPeering_ListByVPCID(t *testing.T) {
	...
	svc := client.VPCs
	path := "/api/public/v1/vpcs/880b7f98-f062-404d-b33c-458d545696f6/peerings"
	want := []*VPCPeering{
		vPeerTestObj,
	}
	links := &Links{
...
func TestVPCPeering_UpdateByVPCID(t *testing.T) {
	...
	svc := client.VPCs
	path := "/api/public/v1/vpcs/%s/peerings/%s"
	want := vPeerTestObj
