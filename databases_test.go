...
var db = Database{
	...
	Connection: &DatabaseConnection{
		URI:      "postgres://doadmin:zt91mum075ofzyww@dbtest-do-user-3342561-0.db.onparspack.com:25060/defaultdb?sslmode=require",
		Database: "defaultdb",
		Host:     "dbtest-do-user-3342561-0.db.onparspack.com",
		Port:     25060,
		User:     "doadmin",
	...
	StandbyConnection: &DatabaseConnection{
		URI:      "postgres://doadmin:zt91mum075ofzyww@replica-dbtest-do-user-3342561-0.db.onparspack.com:25060/defaultdb?sslmode=require",
		Database: "defaultdb",
		Host:     "replica-dbtest-do-user-3342561-0.db.onparspack.com",
		Port:     25060,
		User:     "doadmin",
		Password: "zt91mum075ofzyww",
		SSL:      true,
	...
	PrivateConnection: &DatabaseConnection{
		URI:      "postgres://doadmin:zt91mum075ofzyww@private-dbtest-do-user-3342561-0.db.onparspack.com:25060/defaultdb?sslmode=require",
		Database: "defaultdb",
		Host:     "dbtest-do-user-3342561-0.db.onparspack.com",
		Port:     25060,
		User:     "doadmin",
	...
	StandbyPrivateConnection: &DatabaseConnection{
		URI:      "postgres://doadmin:zt91mum075ofzyww@private-replica-dbtest-do-user-3342561-0.db.onparspack.com:25060/defaultdb?sslmode=require",
		Database: "defaultdb",
		Host:     "private-replica-dbtest-do-user-3342561-0.db.onparspack.com",
		Port:     25060,
		User:     "doadmin",
		Password: "zt91mum075ofzyww",
		SSL:      true,
...
func TestDatabases_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/databases", func(w http.ResponseWriter, r *http.Request) {
...
`, dbJSON)
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s", dbID)
...
`
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/ca", dbID)
	...
	}{
		{
			...
			want: &Database{
				...
				PrivateConnection: &DatabaseConnection{
					URI:      "postgres://doadmin:zt91mum075ofzyww@private-dbtest-do-user-3342561-0.db.onparspack.com:25060/defaultdb?sslmode=require",
					Database: "defaultdb",
					Host:     "private-dbtest-do-user-3342561-0.db.onparspack.com",
					Port:     25060,
					User:     "doadmin",
					Password: "zt91mum075ofzyww",
					SSL:      true,
...
func TestDatabases_Resize(t *testing.T) {
	...
	dbID := "deadbeef-dead-4aa5-beef-deadbeef347d"
	path := fmt.Sprintf("/api/public/v1/databases/%s/resize", dbID)
...
func TestDatabases_Migrate(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/migrate", dbID)
...
func TestDatabases_UpdateMaintenance(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/maintenance", dbID)
...
func TestDatabases_InstallUpdate(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/install_update", dbID)
...
`
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/backups", dbID)
...
`
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/users/name", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/users", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/users/%s", dbID, userID)
...
func TestDatabases_DeleteUser(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/users/user", dbID)
...
func TestDatabases_ResetUserAuth(t *testing.T) {
	...
	defer teardown()
	dbID := "deadbeef-dead-4aa5-beef-deadbeef347d"
	path := fmt.Sprintf("/api/public/v1/databases/%s/users/user/reset_auth", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/dbs", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/dbs/foo", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/pools", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/pools/pool", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/replicas/replica", dbID)
...
`
	path := fmt.Sprintf("/api/public/v1/databases/%s/replicas", dbID)
...
func TestDatabases_PromoteReplicaToPrimary(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/replicas/replica/promote", dbID)
...
func TestDatabases_SetEvictionPolicy(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/eviction_policy", dbID)
...
func TestDatabases_SetSQLMode(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/sql_mode", dbID)
...
func TestDatabases_GetFirewallRules(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/firewall", dbID)
...
func TestDatabases_GetDatabaseOptions(t *testing.T) {
	...
	path := "/api/public/v1/databases/options"
...
func TestDatabases_GetConfigPostgres(t *testing.T) {
	...
	var (
		dbSvc = client.Databases
		dbID  = "da4e0206-d019-41d7-b51f-deadbeefbb8f"
		path  = fmt.Sprintf("/api/public/v1/databases/%s/config", dbID)
...
func TestDatabases_UpgradeMajorVersion(t *testing.T) {
	...
	var (
		dbID              = "deadbeef-dead-4aa5-beef-deadbeef347d"
		path              = fmt.Sprintf("/api/public/v1/databases/%s/upgrade", dbID)
...
func TestDatabases_CreateTopic(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/topics", dbID)
...
func TestDatabases_UpdateTopic(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/topics/%s", dbID, topicName)
...
func TestDatabases_GetMetricsCredentials(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/databases/metrics/credentials", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, body)
	})
...
func TestDatabases_ListDatabaseEvents(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/events", dbID)
...
func TestDatabases_ListIndexes(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/indexes", dbID)
...
func TestDatabases_DeleteIndexes(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/indexes/%s", dbID, indexName)
...
func TestDatabases_CreateLogsink(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/logsink", dbID)
...
func TestDatabases_GetLogsink(t *testing.T) {
	...
	path := fmt.Sprintf("/api/public/v1/databases/%s/logsink/%s", dbID, logsinkID)
