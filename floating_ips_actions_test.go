...
func TestFloatingIPsActions_Assign(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/floating_ips/192.168.0.1/actions", func(w http.ResponseWriter, r *http.Request) {
		v := new(ActionRequest)
...
func TestFloatingIPsActions_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/floating_ips/192.168.0.1/actions/456", func(w http.ResponseWriter, r *http.Request) {
