...
func TestReservedIPsActions_Assign(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/reserved_ips/192.168.0.1/actions", func(w http.ResponseWriter, r *http.Request) {
		v := new(ActionRequest)
...
func TestReservedIPsActions_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/reserved_ips/192.168.0.1/actions/456", func(w http.ResponseWriter, r *http.Request) {
