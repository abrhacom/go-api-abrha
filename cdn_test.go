...
func TestCDN_ListCDN(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/cdn/endpoints", func(w http.ResponseWriter, r *http.Request) {
        ...
        "endpoints": [
          {
            ...
            "origin": "my-space.nyc3.parspackspaces.com",
            "endpoint": "my-space.nyc3.cdn.parspackspaces.com",
            "ttl": 3600,
            "created_at": "2012-10-02T15:00:01.05Z"
          },
          {
            "id": "892071a0-bb95-55bd-8021-3afd67a210bf",
            "origin": "my-space1.nyc3.parspackspaces.com",
            "endpoint": "my-space1.nyc3.cdn.parspackspaces.com",
            "ttl": 3600,
...
func TestCDN_GetCDN(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/cdn/endpoints/12345", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(
			w,
			`{
...
func TestCDN_CreateCDN(t *testing.T) {
	...
	req := &CDNCreateRequest{Origin: "my-space.nyc3.parspackspaces.com", TTL: 3600}
...
func TestCDN_FluchCacheCDN(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/cdn/endpoints/12345/cache", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
	})
