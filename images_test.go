...
func TestImages_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/images", func(w http.ResponseWriter, r *http.Request) {
...
func TestImages_GetImageByID(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/images/12345", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestImages_GetImageBySlug(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/images/ubuntu", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{"image":{"id":12345}}`)
	})
...
func TestImage_String(t *testing.T) {
	...
	expected := `go_api_abrha.Image{ID:1, Name:"Image", Type:"snapshot", Distribution:"Ubuntu", Slug:"image", Public:true, Regions:["one" "two"], MinDiskSize:20, SizeGigaBytes:2.36, Created:"2013-11-27T09:24:55Z", Description:"", Status:"", ErrorMessage:""}`
