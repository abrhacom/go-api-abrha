	...
	createResponseJSON := `
{
	...
	mux.HandleFunc("/api/public/v1/registry", func(w http.ResponseWriter, r *http.Request) {
...
func TestRegistry_DockerCredentials(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			mux.HandleFunc("/api/public/v1/registry/docker-credentials", func(w http.ResponseWriter, r *http.Request) {
...
func TestRepository_List(t *testing.T) {
	...
	"links": {
	    "pages": {
			"next": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories?page=2",
			"last": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories?page=2"
		}
	},
	"meta": {
	    "total": 2
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/registry/%s/repositories", testRegistry), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
	...
	wantRespLinks := &Links{
		Pages: &Pages{
			Next: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories?page=2", testRegistry),
			Last: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories?page=2", testRegistry),
		},
	}
...
func TestRepository_ListV2(t *testing.T) {
	...
	baseLinkPage := fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositoriesV2", testRegistry)
	getResponseJSON := `{
	"repositories": [
		{
			"registry_name": "` + testRegistry + `",
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/registry/%s/repositoriesV2", testRegistry), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
	...
	wantRespLinks := &Links{
		Pages: &Pages{
			First: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositoriesV2?page=1&page_size=1", testRegistry),
			Prev:  fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositoriesV2?page=2&page_size=1&page_token=aaa", testRegistry),
			Next:  fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositoriesV2?page=4&page_size=1&page_token=ccc", testRegistry),
			Last:  fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositoriesV2?page=5&page_size=1", testRegistry),
		},
	}
	assert.Equal(t, wantRespLinks, gotRespLinks)
...
func TestRepository_ListTags(t *testing.T) {
	...
	"links": {
	    "pages": {
			"next": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories/` + testEncodedRepository + `/tags?page=2",
			"last": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories/` + testEncodedRepository + `/tags?page=2"
		}
	},
	"meta": {
	    "total": 2
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/registry/%s/repositories/%s/tags", testRegistry, testEncodedRepository), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		testFormValues(t, r, map[string]string{"page": "1", "per_page": "1"})
		fmt.Fprint(w, getResponseJSON)
	})
	...
	wantRespLinks := &Links{
		Pages: &Pages{
			Next: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories/%s/tags?page=2", testRegistry, testEncodedRepository),
			Last: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories/%s/tags?page=2", testRegistry, testEncodedRepository),
		},
	}
	assert.Equal(t, wantRespLinks, gotRespLinks)
...
func TestRegistry_DeleteTag(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/registry/%s/repositories/%s/tags/%s", testRegistry, testEncodedRepository, testTag), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
	})
...
func TestRegistry_ListManifests(t *testing.T) {
	...
	"links": {
	    "pages": {
			"first": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories/` + testEncodedRepository + `/digests?page=1&page_size=1",
			"prev": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories/` + testEncodedRepository + `/digests?page=2&page_size=1",
			"next": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories/` + testEncodedRepository + `/digests?page=4&page_size=1",
			"last": "https://api.abrha.com/v2/registry/` + testRegistry + `/repositories/` + testEncodedRepository + `/digests?page=5&page_size=1"
		}
	},
	"meta": {
	    "total": 5
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/registry/%s/repositories/%s/digests", testRegistry, testEncodedRepository), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
	...
	wantRespLinks := &Links{
		Pages: &Pages{
			First: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories/%s/digests?page=1&page_size=1", testRegistry, testEncodedRepository),
			Prev:  fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories/%s/digests?page=2&page_size=1", testRegistry, testEncodedRepository),
			Next:  fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories/%s/digests?page=4&page_size=1", testRegistry, testEncodedRepository),
			Last:  fmt.Sprintf("https://api.abrha.com/v2/registry/%s/repositories/%s/digests?page=5&page_size=1", testRegistry, testEncodedRepository),
		},
	}
	assert.Equal(t, wantRespLinks, gotRespLinks)
...
func TestRegistry_DeleteManifest(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1/registry/%s/repositories/%s/digests/%s", testRegistry, testEncodedRepository, testDigest), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
	})
	...
	requestResponseJSONTmpl := `
{
  "garbage_collection": {
	...
	mux.HandleFunc("/api/public/v1/registry/"+testRegistry+"/garbage-collection",
	...
	requestResponseJSONTmpl := `
{
  "garbage_collections": [
	...
	"links": {
	    "pages": {
			"next": "https://api.abrha.com/v2/registry/` + testRegistry + `/garbage-collections?page=2",
			"last": "https://api.abrha.com/v2/registry/` + testRegistry + `/garbage-collections?page=2"
		}
	},
	"meta": {
	    "total": 2
	...
	mux.HandleFunc("/api/public/v1/registry/"+testRegistry+"/garbage-collections",
		func(w http.ResponseWriter, r *http.Request) {
			testMethod(t, r, http.MethodGet)
			testFormValues(t, r, map[string]string{"page": "1", "per_page": "1"})
			fmt.Fprint(w, requestResponseJSON)
	...
	wantRespLinks := &Links{
		Pages: &Pages{
			Next: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/garbage-collections?page=2", testRegistry),
			Last: fmt.Sprintf("https://api.abrha.com/v2/registry/%s/garbage-collections?page=2", testRegistry),
		},
	}
	assert.Equal(t, wantRespLinks, gotRespLinks)
	...
	requestResponseJSONTmpl := `
{
  "garbage_collection": {
	...
	mux.HandleFunc("/api/public/v1/registry/"+testRegistry+"/garbage-collection/"+testGCUUID,
		func(w http.ResponseWriter, r *http.Request) {
	...
	responseJSON := `
{
  "options": {
	...
	mux.HandleFunc("/api/public/v1/registry/options", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
`
	...
	mux.HandleFunc("/api/public/v1/registry/subscription", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, getResponseJSON)
	})
...
func TestRegistry_UpdateSubscription(t *testing.T) {
  ...
  "subscription": {
	...
	mux.HandleFunc("/api/public/v1/registry/subscription",
		func(w http.ResponseWriter, r *http.Request) {
...
func TestRegistry_ValidateName(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/registry/validate-name", func(w http.ResponseWriter, r *http.Request) {
