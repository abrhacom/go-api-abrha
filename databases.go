...
const (
	databaseBasePath                    = "/api/public/v1/databases"
...
// The DatabasesService provides access to the Abrha managed database
...
// here as DatabaseDBs.
//
// See: https://docs.parspack.com/reference/api/cloud-server/#tag/Databases
...
// Database represents a Abrha managed database product. These managed databases
