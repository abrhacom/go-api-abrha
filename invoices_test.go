...
func TestInvoices_GetInvoices(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/customers/my/invoices/example-invoice-uuid", func(w http.ResponseWriter, r *http.Request) {
			...
			"invoice_items": [
				{
					"product": "Vms",
					"resource_id": "1234",
					"resource_uuid": "vm-1234-uuid",
					"group_description": "",
					"description": "My Example Vm",
					"amount": "12.34",
					"duration": "672",
					"duration_unit": "Hours",
...
func TestInvoices_ListInvoices(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/customers/my/invoices", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
			"invoices": [
				{
...
func TestInvoices_GetSummary(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/customers/my/invoices/example-invoice-uuid/summary", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
...
func TestInvoices_GetPDF(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/customers/my/invoices/example-invoice-uuid/pdf", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestInvoices_GetCSV(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/customers/my/invoices/example-invoice-uuid/csv", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
