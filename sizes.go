...
// See: https://docs.parspack.com/reference/api/cloud-server/#tag/Sizes
...
// DiskInfo containing information about the disks available to Vms created
// with this size.
