...
var vTestObj = &VPC{
	...
	RegionSlug:  "s2r7",
	CreatedAt:   time.Date(2019, 2, 4, 21, 48, 40, 995304079, time.UTC).Format(time.RFC3339Nano),
	Default:     false,
}
...
func TestVPCs_Update(t *testing.T) {
	...
	for _, tt := range tests {
		...
		mux.HandleFunc("/api/public/v1/vpcs/"+tt.id, func(w http.ResponseWriter, r *http.Request) {
...
func TestVPCs_ListMembers(t *testing.T) {
	tests := []struct {
		...
		"members": [
			...
			{
				"urn": "do:vm:86e29982-03a7-4946-8a07-a0114dff8754",
		...
		{
			desc:          "list vm members",
			expectedQuery: "vm",
			query:         &VPCListMembersRequest{ResourceType: "vm"},
			resp: `{
		"members": [
			{
				"urn": "do:vm:86e29982-03a7-4946-8a07-a0114dff8754",
	...
	id := "880b7f98-f062-404d-b33c-458d545696f6"
	path := "/api/public/v1/vpcs/" + id + "/members"
