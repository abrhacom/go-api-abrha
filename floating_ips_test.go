...
func TestFloatingIPs_ListFloatingIPs(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/floating_ips", func(w http.ResponseWriter, r *http.Request) {
...
func TestFloatingIPs_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/floating_ips/192.168.0.1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{"floating_ip":{"region":{"slug":"nyc3"},"vm":{"id":"1"},"ip":"192.168.0.1","project_id":"46d8977a-35cd-11ed-909f-43c99bbf6032", "locked":false}}`)
	})
	...
	expected := &FloatingIP{Region: &Region{Slug: "nyc3"}, Vm: &Vm{ID: "1"}, IP: "192.168.0.1", Locked: false, ProjectID: "46d8977a-35cd-11ed-909f-43c99bbf6032"}
