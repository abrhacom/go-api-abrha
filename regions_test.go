...
func TestRegions_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/regions", func(w http.ResponseWriter, r *http.Request) {
...
func TestRegion_String(t *testing.T) {
	...
	expected := `go_api_abrha.Region{Slug:"region", Name:"Region", Sizes:["1" "2"], Available:true}`
