...
func TestUptimeChecks_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks", func(w http.ResponseWriter, r *http.Request) {
...
func TestUptimeChecks_GetState(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks/check-1/state", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestUptimeChecks_GetWithID(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks/check-1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
...
func TestUptimeChecks_Update(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks/check-id", func(w http.ResponseWriter, r *http.Request) {
...
func TestUptimeAlert_Delete(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks/check-1/alerts/alert-1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
	})
...
func TestUptimeAlert_Update(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks/check-id/alerts/alert-id", func(w http.ResponseWriter, r *http.Request) {
		reqBytes, respErr := io.ReadAll(r.Body)
		if respErr != nil {
...
func TestUptimeAlert_Create(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks/check-id/alerts", func(w http.ResponseWriter, r *http.Request) {
...
func TestUptimeAlerts_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/uptime/checks/check-1/alerts", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
