...
func TestAction_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/actions", func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprint(w, `{
			"actions": [
				{
					"id": 1
...
func TestAction_ListActionMultiplePages(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/actions", func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprint(w, `{"actions": [{"id":1},{"id":2}], "links":{"pages":{"next":"http://example.com/v1/vms/?page=2"}}}`)
		testMethod(t, r, http.MethodGet)
	})
...
func TestAction_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1/actions/12345", func(w http.ResponseWriter, r *http.Request) {
...
func TestAction_String(t *testing.T) {
	...
	expected := `go_api_abrha.Action{ID:1, Status:"in-progress", Type:"transfer", ` +
		`StartedAt:go_api_abrha.Timestamp{2014-05-08 20:36:47 +0000 UTC}, ` +
		`ResourceID:"123", ResourceType:"", RegionSlug:""}`
