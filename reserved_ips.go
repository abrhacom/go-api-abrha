...
const reservedIPsBasePath = "api/public/v1/reserved_ips"
...
// Specify VmID to assign the reserved IP to a Vm or Region
...
// Create a reserved IP. If the VmID field of the request is not empty,
// the reserved IP will also be assigned to the vm.
